...
public class PlayerBackEndEvent implements Listener {	
	...
	public void ServerQuit(PlayerQuitEvent PQe) {
		...
		SQLSys.Reserv_(SQLCMD_Reserved.TimeCulcurateor,new String[] {String.valueOf(Time), str});
	}
	...
	public void Death(PlayerDeathEvent PDe) {
		...
		LocalDateTime LDT = LocalDateTime.now().plusMinutes(40);
		Date D = Date.from(LDT.atZone(ZoneId.systemDefault()).toInstant());
		
		Bukkit.getBanList(Type.NAME).addBan(P.getName(), "사망하였습니다.", D, "");
